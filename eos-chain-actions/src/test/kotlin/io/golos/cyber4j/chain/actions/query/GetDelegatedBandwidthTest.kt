...
import io.golos.cyber4j.chain.actions.query.bandwidth.GetDelegatedBandwidth
...
class GetDelegatedBandwidthTest : Spek({
    ...
    given("an Api") {
        ...
        on("v1/chain/get_table_rows -> bandwidth") {
            ...
            val response = io.golos.cyber4j.chain.actions.query.bandwidth.GetDelegatedBandwidth(chainApi).getBandwidth(firstAccountName).blockingGet()

...
import io.golos.cyber4j.chain.actions.query.accountname.CheckAccountNameExists
...
class CheckAccountNameTest : Spek({
    ...
    given("an Api") {
        ...
        on("v1/chain/get_currency_balance -> Account exists") {
            ...
            val accountExists = io.golos.cyber4j.chain.actions.query.accountname.CheckAccountNameExists(chainApi)

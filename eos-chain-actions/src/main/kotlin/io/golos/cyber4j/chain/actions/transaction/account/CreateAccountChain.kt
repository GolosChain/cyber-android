...
import io.golos.cyber4j.chain.actions.transaction.account.actions.buyram.BuyRamBytesArgs
import io.golos.cyber4j.chain.actions.transaction.account.actions.buyram.BuyRamBytesBody
import io.golos.cyber4j.chain.actions.transaction.account.actions.delegatebw.DelegateBandwidthArgs
import io.golos.cyber4j.chain.actions.transaction.account.actions.delegatebw.DelegateBandwidthBody
...
class CreateAccountChain(chainApi: io.golos.cyber4j.http.rpc.ChainApi) : io.golos.cyber4j.chain.actions.transaction.ChainTransaction(chainApi) {
    ...
    private fun newAccountAbi(args: Args, transactionContext: io.golos.cyber4j.chain.actions.transaction.TransactionContext): String {
    ...
    private fun buyRamBytesAbi(args: Args, transactionContext: io.golos.cyber4j.chain.actions.transaction.TransactionContext): String {
    ...
    private fun delegateBandwidthAbi(args: Args, transactionContext: io.golos.cyber4j.chain.actions.transaction.TransactionContext): String {

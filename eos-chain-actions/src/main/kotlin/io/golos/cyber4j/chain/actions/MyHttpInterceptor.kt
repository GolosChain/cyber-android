    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !hasRequestBody) {
                ...
                var charset: Charset? = io.golos.cyber4j.chain.actions.MyHttpInterceptor.Companion.UTF8
                val contentType = requestBody.contentType()
                if (contentType != null) {
                    charset = contentType.charset(io.golos.cyber4j.chain.actions.MyHttpInterceptor.Companion.UTF8)
                }

                logger.log("")
                if (io.golos.cyber4j.chain.actions.MyHttpInterceptor.Companion.isPlaintext(buffer)) {

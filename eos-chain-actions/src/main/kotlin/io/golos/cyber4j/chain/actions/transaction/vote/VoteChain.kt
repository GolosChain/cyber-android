 ...
 */
package io.golos.cyber4j.chain.actions.transaction.vote
...
import io.golos.cyber4j.chain.actions.transaction.vote.actions.VoteArgs
import io.golos.cyber4j.chain.actions.transaction.vote.actions.VoteBody
...
class VoteChain(chainApi: io.golos.cyber4j.http.rpc.ChainApi) : io.golos.cyber4j.chain.actions.transaction.ChainTransaction(chainApi) {

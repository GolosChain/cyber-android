 ...
 */
package io.golos.cyber4j.abi.writer.preprocessor;

import io.golos.cyber4j.abi.writer.AccountNameCollectionCompress;
import io.golos.cyber4j.abi.writer.AccountNameCompress;
import io.golos.cyber4j.abi.writer.AssetCompress;
import io.golos.cyber4j.abi.writer.BlockNumCompress;
import io.golos.cyber4j.abi.writer.BlockPrefixCompress;
import io.golos.cyber4j.abi.writer.BoolCompress;
import io.golos.cyber4j.abi.writer.ByteCompress;
import io.golos.cyber4j.abi.writer.BytesCompress;
import io.golos.cyber4j.abi.writer.ChainIdCompress;
import io.golos.cyber4j.abi.writer.CheckSumCompress;
import io.golos.cyber4j.abi.writer.ChildCompress;
import io.golos.cyber4j.abi.writer.CollectionCompress;
import io.golos.cyber4j.abi.writer.CyberNameCollectionCompress;
import io.golos.cyber4j.abi.writer.CyberNameCompress;
import io.golos.cyber4j.abi.writer.DataCompress;
import io.golos.cyber4j.abi.writer.FloatCompress;
import io.golos.cyber4j.abi.writer.HexCollectionCompress;
import io.golos.cyber4j.abi.writer.IntCompress;
import io.golos.cyber4j.abi.writer.InterfaceCollectionCompress;
import io.golos.cyber4j.abi.writer.LongCollectionCompress;
import io.golos.cyber4j.abi.writer.LongCompress;
import io.golos.cyber4j.abi.writer.NameCompress;
import io.golos.cyber4j.abi.writer.NullableAssetCompress;
import io.golos.cyber4j.abi.writer.NullableCyberNameCompress;
import io.golos.cyber4j.abi.writer.NullableShortCompress;
import io.golos.cyber4j.abi.writer.NullableStringCompress;
import io.golos.cyber4j.abi.writer.PublicKeyCompress;
import io.golos.cyber4j.abi.writer.ShortCompress;
import io.golos.cyber4j.abi.writer.StringCollectionCompress;
import io.golos.cyber4j.abi.writer.StringCompress;
import io.golos.cyber4j.abi.writer.SymbolCodeCompress;
import io.golos.cyber4j.abi.writer.SymbolCompress;
import io.golos.cyber4j.abi.writer.TimestampCompress;
import io.golos.cyber4j.abi.writer.VariableUIntCompress;
import io.golos.cyber4j.abi.writer.preprocessor.model.AbiModel;
import io.golos.cyber4j.abi.writer.preprocessor.model.AbiWriterModel;
import io.golos.cyber4j.abi.writer.preprocessor.model.CompressType;
import io.golos.cyber4j.abi.writer.preprocessor.model.FieldModel;
...
final class ParseAnnotations {
    ...
    private CompressType extractAnnotationType(Element element) {
        ...
        }else if (hasAnnotation(element, NullableCyberNameCompress.class)) {
            return CompressType.NULLABLE_CYBER_NAME;
        }
    ...
    private boolean elementHasFieldAnnotation(Element element) {
        return hasAnnotation(element, NameCompress.class)
                ...
                || hasAnnotation(element, NullableCyberNameCompress.class)
